...
const PreviewerActions: FC<IPreviewerActionsProps> = (props) => {
  ...
  return (
    <>
      <div className="dumi-legecy-previewer-actions">
        {!props.disabledActions?.includes('CSB') && (
          <button
            className="dumi-legecy-previewer-action-btn"
            type="button"
      ...
      {showCode && (
        <>
          <div className="dumi-legecy-previewer-sources">
            {!isSingleFile && (
              <Tabs
                className="dumi-legecy-previewer-tabs"
                prefixCls="dumi-legecy-tabs"
                moreIcon="···"
